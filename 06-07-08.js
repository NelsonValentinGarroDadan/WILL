...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      let amigosNombres = [];
      this.amigos.map((amigo) => amigosNombres.push(amigo.nombre));
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      let promedioEdad,contador;
      this.amigos.map((amigo)=> contador += amigo.edad);
      promedioEdad = contador / this.amigos.length;
      return promedioEdad;
    }
  };
